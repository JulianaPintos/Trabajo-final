...
* Esta consulta actualiza la información de la tabla principal de eventos. En estos casos actualizaremos las columnas de "lugar","barrio","modalidad_formato","aforo" y "eventos" que contiene sus nombres, estos serán reemplazados por el ID de de cada campos.
```sql
UPDATE eventos
